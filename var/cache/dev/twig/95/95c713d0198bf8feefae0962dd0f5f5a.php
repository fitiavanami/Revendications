...
class __TwigTemplate_7644234d318a4da99510aa892ba459bb extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        // line 6
        yield "    <h1>Create new Revendication</h1>
...
{% block title %}New Revendication{% endblock %}

{% block body %}
    <h1>Create new Revendication</h1>

    {{ include('revendication/_form.html.twig') }}

    <a href=\"{{ path('app_revendication_index') }}\">back to list</a>
{% endblock %}
", "revendication/new.html.twig", "/home/fitiavana/Musique/symfony/hafa/revendications/templates/revendication/new.html.twig");
    }
}
