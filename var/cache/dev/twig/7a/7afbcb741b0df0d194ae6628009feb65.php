...
class __TwigTemplate_a39827d4db59abaf9ab71ed368001d5f extends Template
{
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["revendication"]) {
            ...
            yield "</td>
                <td>";
            // line 25
            yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["revendication"], "dateCreation", [], "any", false, false, false, 25)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, $context["revendication"], "dateCreation", [], "any", false, false, false, 25), "Y-m-d H:i:s"), "html", null, true)) : (""));
            yield "</td>
                <td>";
            // line 26
...
{% endblock %}
", "revendication/index.html.twig", "/home/fitiavana/Musique/symfony/revendications/templates/revendication/index.html.twig");
    }
}
